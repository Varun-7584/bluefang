...
class LicensePlateBeaconFactory extends BeaconFactory
    implements IBeaconFactory {
  LicensePlateBeaconFactory() : super();

  @override
  void registerFactory() {
    super.addToMap(
        BeaconType.licensePlateNumberBeacon, LicensePlateBeaconFactory());
  }
  ...
  Either<dynamic, IBeacon> createBeacons(BFBluetoothScanResult scanResult) {
    try {
      ...
      final LicensePlateBeacon beacon = LicensePlateBeacon.fromJson(jsonMap);
      return right(beacon);
    } catch (err) {
      return left(throw "Error parsing beacons");
    }
  }
