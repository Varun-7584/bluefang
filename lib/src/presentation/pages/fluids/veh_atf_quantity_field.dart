...
class VehATFQuantityField extends HookWidget {
  VehATFQuantityField({Key? key}) : super(key: key);
        ...
        children: <Widget>[
          Expanded(
            child: BFTextInput(
                ...
                hintText: AppLocalizations.of(context)!.atfQuantity,
                label: AppLocalizations.of(context)!.atfQuantity,
                outline: true,
                maxLength: 5,
                inputFormatterList: [
                ...
                onChanged: (String value) {
                  try {
                    if (value == "") {
                      return context
                          .read<FluidsformBloc>()
                          .add(FluidsformEvent.atfQuantityChanged(0));
                    } else {
                      return context.read<FluidsformBloc>().add(
                          FluidsformEvent.atfQuantityChanged(
                              double.parse(value)));
                    }
                  } catch (e, s) {
                    // 
                    if (e is FormatException) {
                      ...
                      log("Error: ",
                          name: "ATFQuantityField", error: e, stackTrace: s);
                    }
                  }
                },
