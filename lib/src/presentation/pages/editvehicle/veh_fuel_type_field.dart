...
class VehFuelTypeField extends HookWidget {
  VehFuelTypeField({Key? key, required this.fuelType}) : super(key: key);
  int fuelType;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<EditVehicleBloc, EditVehicleState>(
        ...
        builder: (context, state) {
          ...
          dropdownValue = (
              language == "es" ? 
              ReferenceTableDataES.vehicleFuelType[fuelType] ?? "S_Undefined"
              : (language == "fr"
                ? ReferenceTableDataFR.vehicleFuelType[fuelType] ?? "F_Undefined"
                : ReferenceTableDataEN.vehicleFuelType[fuelType] ?? "Undefined"
              )
            );
            ...
            whenChanged: (String value) {
              language == "es" 
                ? context.read<EditVehicleBloc>().add(
                  EditVehicleEvent.fuelTypeChanged(
