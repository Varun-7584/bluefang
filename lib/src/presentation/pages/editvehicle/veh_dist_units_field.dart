        ...
        builder: (context, state) {
          ...
          return BFDropdown(
            ...
            dropdownValue: language == "es" ? 
              ReferenceTableDataES.uomDistance[context.read<ProgramdatatracformBloc>().state.programmedDataTrac.sensor.dtUom.getOrCrash()] ?? "S_Undef"
              : (language == "fr"
                ? ReferenceTableDataFR.uomDistance[context.read<ProgramdatatracformBloc>().state.programmedDataTrac.sensor.dtUom.getOrCrash()] ?? "F_Undef"
                : ReferenceTableDataEN.uomDistance[context.read<ProgramdatatracformBloc>().state.programmedDataTrac.sensor.dtUom.getOrCrash()] ?? "Undef"
              )
          );
        });
  }
