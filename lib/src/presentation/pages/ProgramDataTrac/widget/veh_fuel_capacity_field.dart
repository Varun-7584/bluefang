...
class VehFuelCapacityField extends StatefulWidget {
  ...
  VehFuelCapacityField({required this.fuelCapacity}) : super();

  @override
  State<VehFuelCapacityField> createState() => VehFuelCapacityFieldState(fuelCapacity: fuelCapacity);
}

class VehFuelCapacityFieldState extends State<VehFuelCapacityField>{
  VehFuelCapacityFieldState({required this.fuelCapacity}) : super();
              ...
              Expanded(
                child: BFInputAndImage(
                    ...
                    onChanged: (String value) {
                      try {
                        if (value == "") {
                          return context.read<ProgramdatatracformBloc>().add(
                              ProgramdatatracformEvent.fuelCapacityChanged(0));
                        } else {
                          return context.read<ProgramdatatracformBloc>().add(
                              ProgramdatatracformEvent.fuelCapacityChanged(
