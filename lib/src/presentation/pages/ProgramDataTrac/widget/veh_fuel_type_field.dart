  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProgramdatatracformBloc, ProgramdatatracformState>(
        ...
        builder: (context, state) {
          ...
          dropdownValue = (
              language == "es" ? 
              ReferenceTableDataES.vehicleFuelType[context.read<ProgramdatatracformBloc>().state.programmedDataTrac.modelAndFuel.vehFuelType.getOrCrash()] ?? "S_Undefined"
              : (language == "fr"
                ? ReferenceTableDataFR.vehicleFuelType[context.read<ProgramdatatracformBloc>().state.programmedDataTrac.modelAndFuel.vehFuelType.getOrCrash()] ?? "F_Undefined"
                : ReferenceTableDataEN.vehicleFuelType[context.read<ProgramdatatracformBloc>().state.programmedDataTrac.modelAndFuel.vehFuelType.getOrCrash()] ?? "Undefined"
              )
            );
            ...
            whenChanged: (String value) {
              language == "es" 
                ? context.read<ProgramdatatracformBloc>().add(
                  ProgramdatatracformEvent.fuelTypeChanged(
